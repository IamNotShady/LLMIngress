...
- [x] 2026-06-28 Console UI quality polish (feat-121):
  ...
  - Residual observation: the existing Create Virtual Model route dialog still produces horizontal page overflow at 1280px because of pre-existing dialog geometry relative to the sidebar. It was left unchanged because feat-121 explicitly forbids layout/width/position changes; the new overflow invariant covers Overview, Providers, Activity, and Limits and passed at both required widths.
