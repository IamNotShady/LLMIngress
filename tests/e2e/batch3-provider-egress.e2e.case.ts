...
const scenarios: EgressScenario[] = [
  ...
  {
    baseUrlSuffix: "/cline_pass/api/v1",
    displayName: "ClinePass",
    expectedProviderPath: "/cline_pass/api/v1/chat/completions",
    id: "cline_pass",
    modelDisplayName: "Claude Sonnet 4.5",
    modelId: "claude-sonnet-4-5",
    providerApiKey: "sk_cline-pass-egress-001",
    providerKey: "cline_pass",
    providerTemplateId: "cline_pass",
    requestId: "req_batch3_cline_pass_001",
    virtualModelDisplayName: "Batch3 ClinePass",
    virtualModelName: "batch3-cline-pass",
  },
  {
    baseUrlSuffix: "/byteplus_coding/api/coding/v3",
    displayName: "BytePlus ModelArk",
    expectedProviderPath: "/byteplus_coding/api/coding/v3/chat/completions",
    id: "byteplus_coding",
    modelDisplayName: "DeepSeek V3.2",
    modelId: "deepseek-v3.2",
    providerApiKey: "sk-byteplus-coding-egress-001",
    providerKey: "byteplus_coding",
    providerTemplateId: "byteplus_coding",
    requestId: "req_batch3_byteplus_coding_001",
    virtualModelDisplayName: "Batch3 BytePlus",
    virtualModelName: "batch3-byteplus-coding",
  },
];
