...
const apiKey = "llmi_v1_batch4_provider_egress_key_001";

// Batch 4 egress: the seven pay-as-you-go inference clouds are OpenAI
// chat_completions api_key providers. Each must route egress to
// base + /chat/completions with a Bearer credential against a mocked upstream,
// and record a succeeded request_activity row.
type EgressScenario = {
...
const scenarios: EgressScenario[] = [
  {
    baseUrlSuffix: "/groq/openai/v1",
    displayName: "Groq",
    expectedProviderPath: "/groq/openai/v1/chat/completions",
    id: "groq",
    modelDisplayName: "Llama 3.3 70B",
    modelId: "llama-3.3-70b-versatile",
    providerApiKey: "gsk_groq-egress-0000000000000000000001",
    providerKey: "groq",
    providerTemplateId: "groq",
    requestId: "req_batch4_groq_001",
    virtualModelDisplayName: "Batch4 Groq",
    virtualModelName: "batch4-groq",
  },
  {
    baseUrlSuffix: "/cerebras/v1",
    displayName: "Cerebras",
    expectedProviderPath: "/cerebras/v1/chat/completions",
    id: "cerebras",
    modelDisplayName: "Llama 3.1 8B",
    modelId: "llama3.1-8b",
    providerApiKey: "csk-cerebras-egress-0000000000000001",
    providerKey: "cerebras",
    providerTemplateId: "cerebras",
    requestId: "req_batch4_cerebras_001",
    virtualModelDisplayName: "Batch4 Cerebras",
    virtualModelName: "batch4-cerebras",
  },
  {
    baseUrlSuffix: "/fireworks/inference/v1",
    displayName: "Fireworks AI",
    expectedProviderPath: "/fireworks/inference/v1/chat/completions",
    id: "fireworks",
    modelDisplayName: "Llama 4 Maverick",
    modelId: "accounts/fireworks/models/llama4-maverick",
    providerApiKey: "fw_fireworks-egress-0000000000000001",
    providerKey: "fireworks",
    providerTemplateId: "fireworks",
    requestId: "req_batch4_fireworks_001",
    virtualModelDisplayName: "Batch4 Fireworks",
    virtualModelName: "batch4-fireworks",
  },
  {
    baseUrlSuffix: "/mistral/v1",
    displayName: "Mistral",
    expectedProviderPath: "/mistral/v1/chat/completions",
    id: "mistral",
    modelDisplayName: "Mistral Large",
    modelId: "mistral-large-latest",
    providerApiKey: "mistral-egress-00000000000000000001",
    providerKey: "mistral",
    providerTemplateId: "mistral",
    requestId: "req_batch4_mistral_001",
    virtualModelDisplayName: "Batch4 Mistral",
    virtualModelName: "batch4-mistral",
  },
  {
    baseUrlSuffix: "/nvidia/v1",
    displayName: "NVIDIA NIM",
    expectedProviderPath: "/nvidia/v1/chat/completions",
    id: "nvidia",
    modelDisplayName: "Nemotron 4 340B",
    modelId: "nvidia/nemotron-4-340b-instruct",
    providerApiKey: "nvapi-nvidia-egress-000000000000001",
    providerKey: "nvidia",
    providerTemplateId: "nvidia",
    requestId: "req_batch4_nvidia_001",
    virtualModelDisplayName: "Batch4 NVIDIA",
    virtualModelName: "batch4-nvidia",
  },
  {
    baseUrlSuffix: "/xiaomi/v1",
    displayName: "Xiaomi MiMo",
    expectedProviderPath: "/xiaomi/v1/chat/completions",
    id: "xiaomi",
    modelDisplayName: "MiMo 7B",
    modelId: "mimo-7b-rl",
    providerApiKey: "sk-xiaomi-egress-00000000000000001",
    providerKey: "xiaomi",
    providerTemplateId: "xiaomi",
    requestId: "req_batch4_xiaomi_001",
    virtualModelDisplayName: "Batch4 Xiaomi",
    virtualModelName: "batch4-xiaomi",
  },
  {
    baseUrlSuffix: "/ollama_cloud/v1",
    displayName: "Ollama Cloud",
    expectedProviderPath: "/ollama_cloud/v1/chat/completions",
    id: "ollama_cloud",
    modelDisplayName: "GPT-OSS 120B",
    modelId: "gpt-oss:120b",
    providerApiKey: "ollama-cloud-egress-0000000000000001",
    providerKey: "ollama_cloud",
    providerTemplateId: "ollama_cloud",
    requestId: "req_batch4_ollama_cloud_001",
    virtualModelDisplayName: "Batch4 Ollama Cloud",
    virtualModelName: "batch4-ollama-cloud",
  },
];
...
test("batch 4 inference cloud providers route chat_completions egress to a mocked upstream", async () => {
  const fixture = await createTestPostgresFixture({
    databaseNamePrefix: `llmingress_batch4_egress_${randomUUID().replaceAll("-", "_")}`,
  });
...
async function seedRoutes(fixture: Fixture, fakeProviderUrl: string): Promise<void> {
  ...
  await fixture.query(
    "insert into api_keys (id, name, key_prefix, key_hash, enabled) values ($1, 'Batch4 Egress ApiKey', left(gen_random_uuid()::text, 12), gen_random_uuid()::text, true)",
    [seedApiKeyId],
  );
  ...
  await fixture.query(
    "insert into config_versions (version, source, description) values (1, 'console', 'Batch4 egress config')",
  );
}
